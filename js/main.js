...
if (contactForm) {
    contactForm.addEventListener('submit', function (e) {
        ...
        fetch('https://formsubmit.co/ajax/osamaelbably87@gmail.com', {
            method: 'POST',
            headers: {
    ...
    techCards.forEach(card => {
        ...
        card.addEventListener('mousemove', (e) => {
            ...
            if (glow) {
                ...
                glow.style.background = `radial-gradient(circle at ${glowX}% ${glowY}%, rgba(0, 168, 255, 0.25) 0%, transparent 70%)`;
            }
        });
...
function attachParticleEffect(card) {
    ...
    const colors = ['#00A8FF', '#0077B6', '#00E5FF'];
